...
export default function About() {
  return (
    <>
      ...
      <div className="text-center   bg-cyan-400 w-[100%] pt-10 h-36">
        <h2 className="text-xl sm:text-2xl font-semibold mb-2">
          Got a Project?
        </h2>
        <Link
          href="mailto:info@lumify.co.in"
          className="text-base sm:text-lg flex items-center  md:justify-center hover:opacity-80 transition-opacity w-full"
        >
          <CiMail className="mr-2 font-semibold" /> info@lumify.co.in
        </Link>
      </div>
    </>
  );
